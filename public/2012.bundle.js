"use strict";(self.webpackChunkvalhalla=self.webpackChunkvalhalla||[]).push([[2012],{32012:(e,t,i)=>{i.r(t),i.d(t,{AppKitModal:()=>ge,W3mModal:()=>ve,W3mModalBase:()=>me});var o=i(36946),a=i(89822),r=i(64558),s=i(83975),n=i(26414),c=i(75766),l=i(32533),w=i(2971),d=i(94503),p=i(45887),u=i(40137);const h={isUnsupportedChainView:()=>"UnsupportedChain"===p.I.state.view||"SwitchNetwork"===p.I.state.view&&p.I.state.history.includes("UnsupportedChain"),async safeClose(){this.isUnsupportedChainView()||await u.U.isSIWXCloseDisabled()?c.W.shake():c.W.close()}};var m=i(47745),v=i(66566),g=i(23237),y=i(48814),f=i(2978),b=i(2937);const k=o.AH`
  :host {
    display: block;
