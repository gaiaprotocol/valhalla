/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4f9f6bbfd95b3dfe4226582aa93d1f61)
...
declare namespace Cloudflare {
	interface Env {
		...
		GOOGLE_REDIRECT_URI_WEBVIEW: "https://valhalla.gaia.cc/api/oauth2/callback-webview" | "http://localhost:8081/api/oauth2/callback-webview";
		SESSION_TTL_DAYS: "7";
		JWT_SECRET: string;
