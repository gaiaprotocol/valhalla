/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1bead895987d372b01ba1b82e8a91b05)
// Runtime types generated with workerd@1.20250712.0 2025-07-12 
declare namespace Cloudflare {
	interface Env {
		SIWE_NONCES: KVNamespace;
		FCM_TOKEN_CACHE: KVNamespace;
		ALLOWED_DOMAIN: "valhalla.gaia.cc" | "localhost:8081";
		ALLOWED_URI: "https://valhalla.gaia.cc" | "http://localhost:8081";
		MESSAGE_FOR_WALLET_LOGIN: "Please sign this message to log in to Valhalla.";
		GOOGLE_CLIENT_ID: "797829770593-kv6v54u6gdebc4j4jhedjiql34ugg2fo.apps.googleusercontent.com";
		GOOGLE_REDIRECT_URI: "https://valhalla.gaia.cc/api/oauth2/callback" | "http://localhost:8081/api/oauth2/callback";
		SESSION_TTL_DAYS: "7";
		APPLE_TEAM_ID: "UJ82GS2C87";
		APPLE_CLIENT_ID: "com.gaiaprotocol.valhalla.service";
		APPLE_KEY_ID: "5Y633H9SJ4";
		APPLE_REDIRECT_URI: "https://valhalla.gaia.cc/api/apple-oauth2/callback";
		JWT_SECRET: string;
		...
		CHATROOM: DurableObjectNamespace<import("./worker/index").ChatRoom>;
		DB: D1Database;
